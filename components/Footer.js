...
import { MapPin, Phone, Smartphone, Ambulance, Hospital, Calendar, Users, Mail, ExternalLink } from "lucide-react"
...
const Footer = () => {
  return (
    ...
    <footer
      className="relative text-white overflow-hidden pt-16" // Added pt-16 for space above the form
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-white/90 mb-3">
              Pro-Active Medical College Hospital Ltd is dedicated to providing comprehensive healthcare services with
              state-of-the-art medical facilities and compassionate care.
            </p>
            ...
            <div className="space-y-3">
              <div>
                ...
                <div className="text-white/80 text-sm ml-6">
                  <a href="tel:01902556070" className="hover:text-white transition-colors block">
                    01902556070
                  </a>
                  <a href="tel:01852839686" className="hover:text-white transition-colors block">
                    01852839686
                  </a>
                </div>
              </div>
              <div>
                ...
                <div className="text-white/80 text-sm ml-6">
                  <a href="tel:01902556060" className="hover:text-white transition-colors block">
                    01902556060
                  </a>
                  <a href="tel:01902556061" className="hover:text-white transition-colors block">
                    01902556061
                  </a>
                </div>
              </div>
        ...
        <div className="mt-12 border-t border-white/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-white/80 text-center md:text-left">
              &copy; {new Date().getFullYear()} Pro-Active Medical College Hospital Ltd By Fara IT Limited. All rights
              reserved.
            </p>
