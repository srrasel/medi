...
export default function SeminarVideosPage() {
  const [videos, setVideos] = useState([])
  const [loading, setLoading] = useState(true)
  const [error, setError] = useState(null)
  const [visibleCards, setVisibleCards] = useState(new Set())
  // default category is Seminar
      ...
      <section className="relative py-20 bg-gradient-to-br from-[#017381] via-[#025a65] to-[#034a52] overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center text-white">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Seminar Videos</h1>
            <p className="text-xl md:text-2xl font-light max-w-4xl mx-auto mb-8">Educational seminar videos for medical professionals.</p>
