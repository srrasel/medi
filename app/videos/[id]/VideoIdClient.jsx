        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden max-w-6xl mx-auto">
          ...
          <div className="aspect-video">
            {video.ytId ? (
              ...
              <div className="flex h-full items-center justify-center bg-slate-100 px-6 text-center text-gray-600">
                <div>
                  <p className="mb-4 text-lg font-semibold text-gray-800">This video could not be embedded.</p>
                  {video.sourceUrl ? (
                    <a
                      href={video.sourceUrl}
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center rounded-full bg-[#017381] px-5 py-3 font-medium text-white transition-colors duration-300 hover:bg-[#025a65]"
                    >
                      Open Video
                    </a>
                  ) : (
                    <p>The source video URL is missing.</p>
                  )}
                </div>
              </div>
            )}
