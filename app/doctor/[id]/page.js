...
export default function DoctorPage() {
  ...
  const doctors = [
    ...
    },
    {
      ...
      specialty: "Pediatrics",
      qualifications:
        "MBBS, MD (Paediatrics) Fellowship Training in Paediatric Cardilogy (NSH, India) Associate Professor (Paedi)",
    ...
    },
    {
      ...
      specialty: "Skin & VD Specialist",
      qualifications:
        "MBBS (Dhaka), MCPS (Skin & Sex), DDV (Skin & Sex), BSMMU (Ex-PG Hospital), FCPS ((Skin & Sex-Final P",
  ...
  // Fixed useEffect - removed doctors dependency
  useEffect(() => {
    const foundDoctor = doctors.find((d) => d.id === Number.parseInt(id))
